...
echo  '########################################'
docker build -t="devadaptive/storm:0.10.0" ${STORM_SCRIPT_DIR}/storm
#docker tag devadaptive/storm:0.10.0 devadaptive/storm:latest

echo  '########################################'
echo  '## building storm-nimbus              ##'
echo  '########################################'
docker build -t="devadaptive/storm-nimbus:0.10.0" ${STORM_SCRIPT_DIR}/storm-nimbus
...
echo  '########################################'
docker build -t="devadaptive/storm-ui:0.10.0" ${STORM_SCRIPT_DIR}/storm-ui
